...
- Update 2026-08-06 -- By request, Mastering Turbo Pascal 5.5 source files are now unpacked from their ARC archives and can now be edited and used directly. Download MTP 5.5.zip and unpack. Inside there are two folders:

* disk1 -- original diskette contents
* source -- unpacked Pascal source files in subfolders by chapter or topic
* README.txt -- original text 
